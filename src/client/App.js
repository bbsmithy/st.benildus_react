  ...
  render() {
    return (
      <Switch>
        ...
        <Route exact path="/about/administration-staff" component={Administration} />
        ...
        <Route exact path="/academia/transition-year" component={TransistionYear} />

        {/*****Enrolement*******/}

        <Route exact path="/enrolement" component={EnrolmentForm} />
        {/*****Extra Curricular*******/}
        <Route exact path="/extra-curricular/bank-of-ireland-program" component={BOIBankProgram} />
        <Route exact path="/extra-curricular/sports" component={Sports} />
        <Route exact path="/extra-curricular/community-initiatives" component={CommunityInitiatives} />
        ...
        <Route exact path="/student-services/guidance-services" component={GuidanceServices} />
        <Route exact path="/student-services/student-council" component={StudentCouncil} />
        <Route exact path="/student-services/study-tips-services" component={StudyTips} />
