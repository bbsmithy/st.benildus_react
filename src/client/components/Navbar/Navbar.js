      ...
      <div>
        <header className="header">
          <div className="header-main container">
            <div className="logo col-md-5 col-sm-12">
              <Link to={'/'}>
                <img id="logo" width="200px" src={require('../../../assets/fullheader.png')} alt="Logo" />
              </Link>
            </div>
        ...
        <nav className="main-nav" role="navigation">
          <div className="container">
            ...
            <div className={this.state.responsiveNavbarStyle} id="navbar-collapse">
              <ul className="nav navbar-nav">
                ...
                <Tab title={'About'} active={this.props.active}>
                  ...
                  <li>
                    <Link to={'/about/administration-staff'}>Administration & Staff</Link>
                  </li>
                </Tab>
                <Tab title={'Academia'} active={this.props.active}>
                  ...
                  <li>
                    <Link to={'/academia/transition-year'}>Transistion Year</Link>
                  </li>
                </Tab>
                ...
                <Tab title={'Extra Curricular'} active={this.props.active}>
                  ...
                  <li>
                    <Link to={'/extra-curricular/community-initiatives'}>Community Initiatives</Link>
                  </li>
                  <li>
                    <Link to={'/extra-curricular/gaisce'}>Gaisce</Link>
                  </li>
                  <li>
                    <Link to={'/extra-curricular/bank-of-ireland-program'}>BOI Secondary Programme</Link>
                  </li>
                  <li>
                ...
                <Tab title={'Parents'} active={this.props.active}>
                  ...
                  <li>
                    <Link to={'/parents/parents-association'}>Parents Association</Link>
                  </li>
                  <li>
                    <Link to={'/parents/policy-procedure'}>Policy Procedure</Link>
                  </li>
                </Tab>
                <Tab title={'Student Services'} active={this.props.active}>
                  <li>
                    <Link to={'/student-services/guidance-services/'}>Guidance Services</Link>
                  </li>
                  <li>
                    <Link to={'/student-services/student-council/'}>Student Council</Link>
                  </li>
                  <li>
                    <Link to={'/student-services/study-tips-services/'}>Study Tips & Services</Link>
                  </li>
                </Tab>
                <Tab title={'Enrolement'} root={'/enrolement/'} active={this.props.active} />
